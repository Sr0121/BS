...
$(document).ready(function(){
    $('#home_btn_learn_1').click(function(){
        $.ajax({url:'/home/change', type:'post' , dataType:'json' , data:{"type":"level_4", "num":$('#home_learn_1').val()} , async:false, success:function(data){
        }});
    });
    $('#home_btn_learn_2').click(function(){
        $.ajax({url:'/home/change', type:'post' , dataType:'json' , data:{"type":"level_6", "num":$('#home_learn_2').val()} , async:false, success:function(data){
        }});
    });
    $('#home_btn_learn_3').click(function(){
        $.ajax({url:'/home/change', type:'post' , dataType:'json' , data:{"type":"toefl", "num":$('#home_learn_3').val()} , async:false, success:function(data){
        }});
    });
    $('#home_btn_learn_4').click(function(){
        $.ajax({url:'/home/change', type:'post' , dataType:'json' , data:{"type":"IELTS", "num":$('#home_learn_4').val()} , async:false, success:function(data){
        }});
    });
});
